 ...
 * Generated at: 2025-04-03 13:56:54 UTC
...
public final class errorPage_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 static final Logger logger = LoggerFactory.getLogger("errorPage.jsp"); 
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/errorJSONBody.jsp", Long.valueOf(1724401742000L));
    _jspx_dependants.put("/WEB-INF/jsp/loadErrorData.jsp", Long.valueOf(1724401742000L));
    _jspx_dependants.put("/WEB-INF/jsp/errorPageHeader.jsp", Long.valueOf(1724401742000L));
    _jspx_dependants.put("/WEB-INF/jsp/errorPageFooter.jsp", Long.valueOf(1724401742000L));
    _jspx_dependants.put("/static/commonPageHeader.html", Long.valueOf(1724401742000L));
    _jspx_dependants.put("/WEB-INF/jsp/errorPageBody.jsp", Long.valueOf(1724401742000L));
    _jspx_dependants.put("/static/commonPageFooter.html", Long.valueOf(1724401742000L));
    _jspx_dependants.put("/WEB-INF/security.tld", Long.valueOf(1724401742000L));
  }
 ...
 logger.error("Exception in jsp for uri: {}", pageContext.getErrorData().getRequestURI(),pageContext.getException()); 
    ...
    try {
        ...
        if(pageContext != null) {
            ...
            if(errctx != null) {
                ...
                errorDetail = (String)request.getAttribute("jakarta.servlet.error.message");
                ...
                if ( errorCode == 0 ) {
                    ...
                    errcodeStr = (String)request.getAttribute("jakarta.servlet.error.status_code");
                    if ( errcodeStr != null ) {
 ...
 if ( (Integer)request.getAttribute("psc.as.attr.detailLevel") > 1) { 
      ...
      out.print((Integer)request.getAttribute("jakarta.servlet.error.status_code"));
      out.write(" \n");
 ...
 if ( (Integer)request.getAttribute("psc.as.attr.detailLevel") > 2) { 
      ...
      out.write("\"\n");
      out.write(", \"servlet\": \"");
      out.print((String)request.getAttribute("jakarta.servlet.error.servlet_name"));
      out.write("\"\n");
      out.write(", \"uri\": \"");
      out.print((String)request.getAttribute("jakarta.servlet.error.request_uri"));
      out.write("\"\n");
 ...
 if ( (Integer)request.getAttribute("psc.as.attr.detailLevel") > 2) { 
      ...
      out.write("	<span>Copyright &copy; 1993-2022 Progress Software Corporation. All rights reserved.</span>\n");
      out.write("</div>\n");
      out.write("\n");
      out.write("</body>\n");
      out.write("</html>\n");
